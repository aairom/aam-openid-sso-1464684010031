...
// redirection vers l'appli elle-même
// var callback_url = 'https://aam-openid-sso.mybluemix.net/
var callback_url = 'https://aam-openid-sso.mybluemix.net/auth/sso/callback';
// redirection vers l'appli contenant les données
// var callback_url = 'http://aam-nodejs-starterpack-18052016.mybluemix.net';
...
app.get('/hello', ensureAuthenticated, function(request, response) {
    ...
    response.send('Hello, '+ request.user['id'] + '!\n' + '<a href="amazing.txt">amazing.txt</a>');
});
